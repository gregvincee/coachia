...
const styles = StyleSheet.create({
  ...
  card: { width: "100%", maxWidth: 360, flexDirection: "row", alignItems: "center", gap: 12, borderRadius: 20, padding: 18, backgroundColor: "#151820", borderColor: "#C89D56", borderWidth: 1, shadowColor: "#000", shadowOpacity: 0.4, shadowRadius: 16, shadowOffset: { width: 0, height: 8 }, elevation: 8 },
  check: { width: 42, height: 42, alignItems: "center", justifyContent: "center", borderRadius: 21, backgroundColor: "#D6B36A" },
  checkText: { color: "#FFFFFF", fontSize: 22, fontWeight: "800" },
  copy: { flex: 1 },
  title: { color: "#FFFFFF", fontSize: 16, fontWeight: "800" },
  message: { marginTop: 3, color: "#AEB4C0", fontSize: 13, lineHeight: 18 },
});
