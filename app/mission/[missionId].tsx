...
function DiagnosisPanel({ missionId, diagnosis, learning, onRetry, onOpenCoach }: { missionId: MissionTrackId; diagnosis: MissionDiagnosis; learning: MissionLearningState; onRetry: () => void; onOpenCoach: () => void }) {
  ...
  return (
    <View className="gap-5 rounded-3xl border border-[#C89D56] bg-[#151820] p-5">
      ...
      <TouchableOpacity accessibilityRole="button" accessibilityLabel="Appliquer les conseils et faire une nouvelle tentative" onPress={onRetry} activeOpacity={0.8} className="items-center rounded-xl bg-[#D6B36A] px-4 py-4"><Text className="font-bold text-white">Appliquer les conseils et réessayer</Text></TouchableOpacity>
